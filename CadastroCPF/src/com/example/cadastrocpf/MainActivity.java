package com.example.cadastrocpf;
...
public class MainActivity extends Activity {
	EditText edtNome,edtRG,edtCPF,edtTel,edtData;
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        edtData=(EditText)findViewById(R.id.editText4);
        edtTel=(EditText)findViewById(R.id.editText5);
    }
    ...
    public void Cadastrar(View v) throws UnsupportedEncodingException{
    	...
    	String nascimento = edtData.getText().toString().trim();
    	...
    	data += "&"+URLEncoder.encode("nascimento","UTF-8")+"="+URLEncoder.encode(nascimento,"UTF-8");
